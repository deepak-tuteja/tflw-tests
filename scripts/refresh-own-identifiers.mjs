 ...
 */
export function renderManifest(ids) {
  return JSON.stringify({
    $comment: 'Generated by scripts/refresh-own-identifiers.mjs (M169d2, D-M164-06-7). Do not edit by hand. Identifiers only, by decision: the set of record FILENAMES is part of what this repository\'s .gitignore withholds, and both repositories are public.',
