...
export class AddAccountDeletion1784991251100 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "users" ADD "deactivated_at" TIMESTAMP`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "jobs" ALTER COLUMN "order_id" DROP NOT NULL`,
    );
    ...
    await queryRunner.query(
      `ALTER TYPE "public"."jobs_type_enum" ADD VALUE 'account-deletion'`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "jobs" DROP CONSTRAINT "FK_jobs_user_id"`,
    );
    await queryRunner.query(`ALTER TABLE "jobs" DROP COLUMN "user_id"`);
    await queryRunner.query(
      `ALTER TABLE "jobs" ALTER COLUMN "order_id" SET NOT NULL`,
    );
